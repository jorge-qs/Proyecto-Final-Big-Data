...
{\small\color{gray}
\faGithub\;
\href{https://github.com/jorge-qs/Proyecto-Final-Big-Data}{\texttt{jorge-qs/Proyecto-Final-Big-Data}}
}
...
\fbox{\includegraphics[width=0.9\textwidth]{img/airflow_dag_grid.png}}
...
\fbox{\includegraphics[width=0.85\textwidth]{img/airflow_dag_graph.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.9\textwidth]{img/dashboard_mongodb.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.9\textwidth]{img/dashboard_cassandra.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.9\textwidth]{img/dashboard_neo4j.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.9\textwidth]{img/dashboard_kpis_cards.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.9\textwidth]{img/dashboard_kpis_timeseries.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.9\textwidth]{img/dashboard_neo4j_insights.png}}
